...
## [0.2.1](https://github.com/NickLarsenNZ/cool-diff/compare/v0.2.0...v0.2.1) - 2026-07-01

### Added

- *(experimental)* Generate MatchConfigs for Kubernetes OpenApi specs ([#20](https://github.com/NickLarsenNZ/cool-diff/pull/20))
...
- *(deps)* bump snafu from 0.9.0 to 0.9.1 ([#9](https://github.com/NickLarsenNZ/cool-diff/pull/9))
- Fix example in the readme
- Improve crate categories
- Add crates.io and docs.io badges
